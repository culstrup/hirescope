...
class TestDocumentProcessor:
    ...
    def test_init_with_all_libraries(self):
        ...
        with patch('hirescope.document_processor.PyPDF2', Mock()), \
             patch('hirescope.document_processor.Document', Mock()):
    ...
    def test_init_without_libraries(self, capsys):
        ...
        with patch('hirescope.document_processor.PyPDF2', None), \
             patch('hirescope.document_processor.Document', None):
            processor = DocumentProcessor()
    ...
    def test_extract_text_exception_handling(self, processor):
        ...
        with patch.object(processor, '_extract_pdf_text', side_effect=Exception("Test error")):
    ...
    def test_extract_pdf_text_exception(self, processor):
        ...
        with patch('hirescope.document_processor.PyPDF2.PdfReader', side_effect=Exception("PDF error")):
            result = processor._extract_pdf_text(b"content")
    ...
    def test_extract_docx_text_exception(self, processor):
        ...
        with patch('hirescope.document_processor.Document', side_effect=Exception("DOCX error")):
            result = processor._extract_docx_text(b"content")
    ...
    @pytest.mark.parametrize("filename,content,expected_method", [
    ...
    def test_extract_text_routing(self, processor, filename, content, expected_method):
        ...
        if expected_method:
            with patch.object(processor, expected_method, return_value="Extracted") as mock_method:
    ...
    def test_extract_text_case_insensitive(self, processor):
        ...
        with patch.object(processor, '_extract_pdf_text', return_value="PDF content") as mock_pdf:
            # Test various cases
